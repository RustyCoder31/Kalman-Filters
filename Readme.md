...
2. `python beta.py` — calibrates: fits OLS over the 2025-01-01–2025-03-03 window and writes `beta`, `R`, `Q` to `model_params.json`. Must be run before step 3.
...
Say our starting guess is `b = 1.5`, and the variance of this guess is `P = 0.1` (this is a squared quantity — it tells us how uncertain we are about `b`).

We find the residual: `residual = V - b*H` — this tells us how far off our current guess is.
